...
INSERT INTO CURSO (id, nombre, fechaInicio, duracion, descripcion, precio, image, categoria_id) VALUES (NEXTVAL('hibernate_sequence'), 'Técnico Avanzado en Obtención de Información en Fuentes Abiertas (OSINT)', '2020-02-28', 6, 'Cualquiera de los diferentes tipos de Inteligencia (Militar, Económica, Competitiva, etc.) necesitan de una correcta y cuidadosa recolección de información.', 313.50, null, null);
INSERT INTO CURSO (id, nombre, fechaInicio, duracion, descripcion, precio, image, categoria_id) VALUES (NEXTVAL('hibernate_sequence'), 'Fundamentos de Inteligencia y Contrainteligencia', '2018-06-19', 6, 'Este curso está diseñado para aquellos alumnos que necesitan familiarizarse, conocer, comprender y utilizar los conceptos fundamentales relacionados con la Inteligencia, la Contrainteligencia y la Seguridad.', 313.50, null, null);




INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Inteligencia e Información', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Amenaza Yihadista', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Terrorismo y Crimen Organizado', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Seguridad y Defensa', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Tecnología Militar', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Estudios Estratégicos', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Historia Militar', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Táctico-Sanitaria Y PRL', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Gestión Ambiental', null);
INSERT INTO CATEGORIA (id, nombre, tipoformacion_id) VALUES (NEXTVAL('hibernate_sequence'), 'Supervivencia, Rescate y Prevención', null);
